...
public class Client  implements ActionListener {
    ...
    Client(){
        ...
        ImageIcon i4= new ImageIcon(ClassLoader.getSystemResource("icons/veena_maam.jpg"));
        ...
        JLabel name = new JLabel("Veena Ma'am");
        name.setBounds(110,10,200,30);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN SERIF",Font.BOLD,25));
        p1.add(name);
